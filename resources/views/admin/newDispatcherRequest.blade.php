                                    ...
                                    <ul class="nav nav-tabs justify-content-center" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#outstation" role="tab">
                                                <i
                                                    class="now-ui-icons shopping_cart-simple"></i>@lang('view_pages.outstation')
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-content text-center">
                                        <div class="tab-pane active" id="home" role="tabpanel">
                                            ...
                                            <div class="radio_book">
                                                <input class="form-check-input" type="radio" name="book" id="booklater"
                                                    value="booklater">
                                                <label class="form-check-label" for="booklater">
                                                    @lang('view_pages.book_later')
                                                </label>
                                                <input class="form-check-input" type="radio" name="book" id="booknow"
                                                    value="booknow">
                                            ...
                                            <div class="input-group mar1rm">
                                                <input class="form-control w-100" type="text" name="phone"
                                                    placeholder="Phone Number" id="phone" aria-label="phone"
                                                    aria-describedby="basic-addon1">
                                            </div>
                                        ...
                                        <div class="tab-pane" id="rentals" role="tabpanel">
                                            <div class="radio_book">
                                                <input class="form-check-input" type="radio" name="rentalbook"
                                                    id="rentalbooklater" value="rentalbooklater">
                                                <label class="form-check-label" for="rentalbooklater">
                                                    @lang('view_pages.book_later')
                                                </label>
                                                <input class="form-check-input" type="radio" name="rentalbook"
                                                    id="rentalbooknow" value="rentalbooknow">
                                                <label class="form-check-label"
                                                    for="rentalbooknow">@lang('view_pages.book_now')
                                                </label>
                                            </div>
                                            <p class="box-title txtInput">@lang('view_pages.location_details')</p>
                                            <div class="input-group mar1rm">
                                        ...
                                        <div class="tab-pane" id="outstation" role="tabpanel">
                                            <div class="radio_book">
                                                <input class="form-check-input" type="radio" name="outstationbook"
                                                    id="outstationbooklater" value="outstationbooklater">
                                                <label class="form-check-label" for="outstationbooklater">
                                                    @lang('view_pages.book_later')
                                                </label>
                                                <input class="form-check-input" type="radio" name="outstationbook"
                                                    id="outstationbooknow" value="outstationbooknow">
                                                <label class="form-check-label" for="outstationbooknow">
                                                    @lang('view_pages.book_now')
                                                </label>
                                            </div>
