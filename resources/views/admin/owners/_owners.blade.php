            ...
            <div class="card-body">
                <div class="col-sm-12 p-0">
                    <table class="table table-hover"
                        ...
                        <tbody>
                            @if (count($results) < 1) <td class="no-result" colspan="11">{{
                                trans('view_pages.no_data_found')}}</td>
                                @else
                                ...
                                <tr>
                                    ...
                                    <td class="manage-driver text-center">
                                        <a href="{{url('owners/document/view', $result->id) }}"
                                    ...
                                    <td>
                                        @if ($result->approve == '1')
                                        <span
                                            class="badge badge-success font-size-10">{{trans('view_pages.approved')}}</span>
                                        @else
                                        <span
                                            class="badge badge-danger font-size-10">{{trans('view_pages.blocked')}}</span>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{url('owners/toggle_approve',$result->id)}}">
                                            ...
                                            <a class="dropdown-item sweet-delete"
                                                href="{{url('owners/delete',$result->id)}}">
                ...
                <td class="action">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a class="grey-text text-darken-2" href="{{url('owners',$result->id) }}">{{
                                trans('view_pages.edit')}}</a>
                            @endif

                            @if (auth()->user()->can('delete-owner'))
                            <a class="sweet-delete grey-text text-darken-2" href="#"
                                data-url="{{url('owners/delete',$result->id) }}">{{ trans('view_pages.delete')}}</a>
                            @endif

                            @if (auth()->user()->can('toggle-owner-status'))
                            @if ($result->approve)
                            <a class="sweet-decline grey-text text-darken-2"
                                href="{{url('owners/toggle_approve',$result->id) }}">{{ trans('view_pages.block')}}</a>
                            @else
                            <a class="sweet-approve grey-text text-darken-2"
                                href="{{url('owners/toggle_approve',$result->id) }}">{{
                                trans('view_pages.approve')}}</a>
                            @endif
                            @endif
                        </div>
                    </div>
