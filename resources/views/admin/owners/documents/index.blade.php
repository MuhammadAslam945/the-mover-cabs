        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ url('owners/by_area',$owner->service_location_id) }}">
                            @lang('view_pages.manage_owner')</a></li>
            ...
            <div class="card-body">
                <div class="col-sm-12 p-0">
                    <div class="form-group">
                        {{-- <p><span> <strong> {{strtoupper($driver->firstname) .' '. strtoupper($driver->lastname)}}
                                </strong></span> <span class="float-right"><b>@lang('view_pages.reg_code')</b>: {{
                                $driver->registration_code }}</span></p> --}}
                    </div>
                </div>
                <div class="col-sm-12 p-0">
                    ...
                    <form action="#" method="post">
                        ...
                        <table class="table table-hover"
                            style="border-collapse: collapse; border-spacing: 0px; width: 100%;" id="DataTables_Table_0"
                            ...
                            <tbody>
                                ...
                                now()->parse($doc_dets->expiry_date)->format('d-m-Y') : '-';
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" name="document_id[]" class="document_id"
                                        value="{{ $owner_doc_id }}">
                                    <input type="hidden" name="document_status[]" class="document_status"
                                        value="{{ $doc_status }}">
                                    ...
                                    <td>
                                        @if($count == 0)
                                        <a href="{{url('owners/upload/document',[$owner->id,$item->id]) }}"
                                            class="fas fa fa-upload"></a>
                                        @else
                                        <a href="{{url('owners/upload/document',[$owner->id,$item->id]) }}"
                                            class="fas fa fa-edit"></a>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <span
                                            class="btn btn-sm btn-outline-success approve">@lang('view_pages.approve')</span>
                                        <span
                                            class="btn btn-sm btn-outline-danger decline">@lang('view_pages.decline')</span>
                                        @endif
                                    </td>
                                </tr>
                                @empty
                                    ...
                                    <td colspan="11">
                                        <p id="no_data" class="lead no-data text-center">
                                            <img src="{{asset('assets/img/dark-data.svg')}}"
                                                style="width:250px;margin-top:25px;" alt="">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-danger btn-sm float-right">
                    @lang('view_pages.close')</button>
                <a href="" class="downloadImage" download>
                    <button type="button"
                        class="btn btn-success btn-sm float-right mr-2">@lang('view_pages.download')</button>
                </a>
            </div>
        </div>
    </div>
