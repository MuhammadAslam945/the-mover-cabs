                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('owner_name')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('street')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" id="house_number"
                                                                ...
                                                                pattern="[A-Za-z0-9/ ]*">
                                                            <span class="text-danger">{{ $errors->first('house_number')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('expiry_date')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('tax_number')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('surname')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('mobile')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger iban_err">{{ $errors->first('iban')
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('bank_name')
                                                                }}</span>
                                                        </div>
                                                    </div>
