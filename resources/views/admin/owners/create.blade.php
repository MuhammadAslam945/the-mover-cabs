                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="basic-pills-wizard" class="twitter-bs-wizard">
                                                ...
                                                <div class="tab-content twitter-bs-wizard-tab-content">
                                                    ...
                                                    <div class="tab-pane" id="owner-details">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="owner_name">@lang('view_pages.owner_name')
                                                                        <span class="text-danger">*</span></label>
                                                                    <input class="form-control" type="text"
                                                            ...
                                                            <div class="col-sm-4 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    <label for="password">@lang('view_pages.password')
                                                                        <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-sm-12 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    <label for="address">@lang('view_pages.address')
                                                                        <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="postal_code">@lang('view_pages.postal_code')
                                                                        <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="admin_id">@lang('view_pages.select_area')<span
                                                                            class="text-danger">*</span></label>
                                                                    <select name="service_location_id"
                                                                        ...
                                                                        <option value="{{ $area->id }}" {{
                                                                            old('service_location_id')==$area->id ?
                                                                            'selected' :
                                                                            '' }}>{{ $area->name }}</option>
                                                                        {{-- @endforeach --}}
                                                                    </select>
                                                            ...
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="text-danger">{{
                                                                        $errors->first('no_of_vehicles') }}</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="tax_number">@lang('view_pages.tax_number')
                                                                        <span class="text-danger">*</span></label>
                                                                    <input class="form-control" type="text"
                                                                ...
                                                                <ul class="admin-add-btn">
                                                                    <li>
                                                                        <button type="submit"
                                                                            ...
                                                                            trans('view_pages.create') }}</button>
                                                                    </li>
                                                                </ul>
                                                            </div> --}}
                                                        </div>
                                                    ...
                                                    <div class="tab-pane" id="contact-person-details">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    <label for="surname">@lang('view_pages.surname')
                                                                        <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" id="mobile"
                                                                        ...
                                                                        required="" placeholder="9521832670">
                                                                    <span class="text-danger">{{
                                                                        $errors->first('mobile')
                                                                        }}</span>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 float-left mb-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="text-danger ifsc_err">{{
                                                                        $errors->first('ifsc')
                                                                        }}</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane" id="documents">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12 pb-3">
                                                                ...
                                                                {{-- <div style="border-bottom: 1px solid #eff2f7;">
                                                                </div> --}}
                                                            </div>
                                                            @endforeach
                                                            ...
                                                            {{-- <div class="col-md-6 float-left">
                                                                <div class="form-group profile-img">
                                                                    <label>{{ trans('view_pages.business_license')}}
                                                                        <span class="text-danger">*</span></label>
                                                                    <div class="col-12" style="display: inline;">
                                                                        <div class="col-md-12 float-left p-0">
                                                                            <img class='img-upload' width="100px"
                                                ...
                                                <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                    <li class="previous"><a href="#">@lang('view_pages.previous')</a>
                                                    </li>
...
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDSMZPVv76A_l4wm4v0ANZl4UIverafDb8&libraries=places&callback=initMap"
    async defer></script>
