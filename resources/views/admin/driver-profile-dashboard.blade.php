                    ...
                    <div class="box-body box-profile">
                        <div class="row">
                            ...
                            <div class="col-md-2 m-auto">
                                <img class="w-fill" src="{{ asset('assets/images/2.jpg') }}" alt="">
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="profile-user-info">
                                    <h3>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="tickets"
                                        class="table mt-0 table-hover no-wrap table-striped table-bordered"
                                        data-page-size="10">
                                        <thead>
                                            <tr class="bg-dark">
                                                <th>Fleet No</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    Daffodil international <br> Unerversity, 102/1, <br> Sukrabad Mirpur
                                                    Rd,
                                        ...
                                        <div class="dataTables_paginate paging_simple_numbers" id="tickets_paginate">
                                            <ul class="pagination">
                                                ...
                                                <li class="paginate_button page-item "><a href="#"
                                                        aria-controls="tickets" data-dt-idx="2" tabindex="0"
