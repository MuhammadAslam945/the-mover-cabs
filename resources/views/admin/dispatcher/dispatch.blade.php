        ...
        <div class="sidebar-contact left">
            ...
            <div>
                <div class="box mb-0">
                    ...
                    <div class="box-body py-0 chart-responsive"
                        style="height: calc(100vh - 124px); overflow-y: scroll;">
                ...
                <div class="box mb-0">
                    <div class="box-header with-border text-right">
                        <h4 class="box-title">
                            ...
                            <button type="button" class="btn btn-primary btn-lg turned-button mr-auto"
                                data-toggle="modal" data-target="#book-now">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 m-auto">
                                                    <ul class="choose-type">
                                                        ...
                                                        <li class="car-img"><a href=""> <img
                                                                    src="{{ asset('images/email/mini.svg') }}"
                                                                    alt=""></a>
                                                        </li>
                                                        <li><a href="">$23</a></li>
                                                    </ul>
                                                ...
                                                <div class="col-md-3 m-auto">
                                                    <ul class="choose-type">
                                                        <li><a href="">Suv</a></li>
                                                        <li class="car-img"><a href=""> <img
                                                                    src="{{ asset('images/email/suv.svg') }}"
                                                                    alt=""></a>
                                                        </li>
                                                        <li><a href="">$63</a></li>
                                                    </ul>
