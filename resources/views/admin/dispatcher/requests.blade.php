                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" style="border-radius:0px;">
                                            ...
                                            <div class="col-md-2 float-left p-0">
                                                <img src="{{ asset('images/email/user.svg') }}" width="25px"
                                        ...
                                        <div class="form-group" style="border-radius:0px;">
                                            ...
                                            <div class="col-md-2 float-left p-0">
                                                <img src="{{ asset('images/email/phone.svg') }}" width="25px"
                                                    style="margin-top:4px" alt="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-10 float-left pr-0">
                                                <input type="text" class="form-control" id="pickup_location"
                                                    value="{{old('pickup_location')}}" placeholder="Pickup Location"
                                                    required="">
                                            </div>
                                            <div class="col-md-2 float-left p-0">
                                                <img src="{{ asset('images/email/home.svg') }}" width="25px"
                                                    style="margin-top:4px" alt="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-10 float-left pr-0">
                                                <input type="text" class="form-control" id="drop_location"
                                                    name="drop_location" value="{{old('drop_location')}}" required=""
                                                    placeholder="Drop Location">
                                            </div>
                                            <div class="col-md-2 float-left p-0">
                                                <img src="{{ asset('images/email/location.svg') }}" width="25px"
                                                    style="margin-top:4px" alt="">
                                            </div>
                                            <a href="" class="drop-plus"> <img
                                                    src="{{ asset('images/email/plus.svg') }}" width="15px" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-3 float-left">
                                        <ul class="choose-type">
                                            ...
                                            <li class="car-img"><a href=""> <img
                                                        src="{{ asset('images/email/mini.svg') }}" alt=""></a></li>
                                            <li><a href="">$23</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-3 float-left">
                                        <ul class="choose-type">
                                            ...
                                            <li class="car-img"><a href=""> <img
                                                        src="{{ asset('images/email/micro.svg') }}" alt=""></a></li>
                                            <li><a href="">$33</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-3 float-left">
                                        <ul class="choose-type">
                                            ...
                                            <li class="car-img"><a href=""> <img
                                                        src="{{ asset('images/email/sedan.svg') }}" alt=""></a></li>
                                            <li><a href="">$53</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-3 float-left">
                                        <ul class="choose-type">
                                            <li><a href="">Suv</a></li>
                                            <li class="car-img"><a href=""> <img
                                                        src="{{ asset('images/email/suv.svg') }}" alt=""></a></li>
                                            <li><a href="">$63</a></li>
                                        </ul>
                                    </div>
                                </div>
