                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($result->status == 0)
                                    <td><button class="btn btn-warning btn-sm">@lang('view_pages.requested')</button>
                                    </td>
                                    @elseif($result->status==1)
                                    <td><button class="btn btn-success btn-sm">@lang('view_pages.approved')</button>
                                    </td>
                                    @else
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{url('withdrawal-requests-lists/approve',$result->id)}}">
                                                    <i class="fa fa-dot-circle-o"></i>@lang('view_pages.approve')</a>
                                                <a class="dropdown-item"
                                                    href="{{url('withdrawal-requests-lists/decline',$result->id)}}">
