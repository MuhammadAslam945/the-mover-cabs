                            ...
                            <form action="#" method="post">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @endforeach
                                        <tr>
                                            <input type="hidden" name="driver_id" class="driver_id"
                                                value="{{ $driver->id }}">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                @if ($doc_status == 1)
                                                <span class="badge badge-success">{{ driver_document_name($doc_status)
                                                    }}</span>
                                                @elseif ($doc_status == 5)
                                                <span class="badge badge-danger">{{ driver_document_name($doc_status)
                                                    }}</span>
                                                @else
                                                <span class="badge badge-warning">{{ driver_document_name($doc_status)
                                                    }}</span>
                                                @endif
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if($count == 0)
                                                <a href="{{ url('drivers/upload/document',[$driver->id,$item->id]) }}"
                                                    class="fas fa fa-upload"></a>
                                                @else
                                                <a href="#" class="open-image" title="View Image">
                                                    <i class="imageresource fas fa fa-file-image-o"
                                                        data-src="{{ $docImage }}"></i>
                                                </a>
                                                {{-- <a href="{{ $docImage }}" class="fas fa fa-download text-purple"
                                                    download></a> --}}
                                                <a href="{{ url('drivers/upload/document',[$driver->id,$item->id]) }}"
                                                    class="fas fa fa-edit"></a>
                                                {{-- <a href="{{ url('drivers/delete/document',[$driver_doc_id]) }}"
                                                    class="fas fa fa-trash text-red sweet-delete"></a> --}}
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                {{-- @if ($doc_status == 1)
                                                <span
                                                    class="btn btn-sm  btn-outline btn-danger decline">@lang('view_pages.decline')</span>
                                                @elseif ($doc_status == 5)
                                                <span
                                                    class="btn btn-sm btn-success btn-outline approve">@lang('view_pages.approve')</span>
                                                @else
                                                <span
                                                    class="btn btn-sm btn-success btn-outline approve">@lang('view_pages.approve')</span>
                                                <span
                                ...
                                <div class="form-group">
                                    <div class="col-12">
                                        <button class="btn btn-primary btn-sm pull-right m-5" id="approveDocument"
                                            type="button">
