                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if ($result->status == 0)
                                            <td><button
                                                    class="btn btn-success btn-sm">@lang('view_pages.requested')</button>
                                            </td>
                                            @elseif($result->status==1)
                                            <td><button
                                                    class="btn btn-danger btn-sm">@lang('view_pages.approved')</button>
                                            </td>
                                            @else
                                            <td><button
                                                    class="btn btn-danger btn-sm">@lang('view_pages.declined')</button>
                                            </td>
                                            @endif
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{url('withdrawal-requests-lists/view',$result->driverDetail->id)}}">
                                                            <i
                                                                class="fa fa-dot-circle-o"></i>@lang('view_pages.view_in_detail')</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
