...
<div class="page-content-wrapper">
                        ...
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                ...
                                <form method="post" class="form-horizontal"
                                    action="{{url('service_location/update/'.$item->id)}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="country">@lang('view_pages.select_country') <span
    ...
    <div class="col-sm-6">
            ...
            <span class="text-danger">{{ $errors->first('currency_symbol') }}</span>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="timezone">@lang('view_pages.timezone') <span
                                                        class="text-danger">*</span></label>
                                                <select name="timezone" id="timezone" class="form-control select2">
                                                    <option value="" selected disabled>@lang('view_pages.select')
                                                    </option>
                                                    @foreach($timezones as $timezone)
                                                    <option value="{{ $timezone->timezone }}" {{ old('timezone',$item->
                                                        timezone)
