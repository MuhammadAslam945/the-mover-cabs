            ...
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('service_location/store')}}"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="timezone" id="timezone" class="form-control select2" required>
                                            ...
                                            <option value="{{ $timezone->timezone }}" {{ old('timezone')==$timezone->
                                                timezone ? 'selected' : '' }}>{{ $timezone->timezone }}</option>
                                            @endforeach
                                        </select>
