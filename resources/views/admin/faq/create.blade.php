                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" class="form-horizontal" action="{{ url('faq/store') }}">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="service_location_id" id="service_location_id" class="form-control"
                                            ...
                                            <option value="{{ $city->id }}" {{ old('service_location_id')==$city->id ?
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="user_type" id="user_type" class="form-control" required>
                                            ...
                                            <option value="owner" {{ old('user_type')=='owner' ? 'selected' : '' }}>
                                                @lang('view_pages.owner')</option>
                                            <option value="all" {{ old('user_type')=='all' ? 'selected' : '' }}>
                                                @lang('view_pages.all')</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="question">@lang('view_pages.question') <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="answer">@lang('view_pages.answer') <span
                                                class="text-danger">*</span></label>
