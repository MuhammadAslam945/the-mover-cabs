                        ...
                        <div class="box-header with-border">
                            <div class="row text-right">
                                ...
                                <div class="col-9 text-right">
                                    <a href="{{url('zone/types/zone_package_price',$zone_type->id)}}"
                                            ...
                                            <td colspan="11">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{-- @if ($result->zone->default_vehicle_type ==
                                                        $result->type_id)
                                                    ...
                                                    @if($result->active)
                                                    <td><button
                                                            class="btn btn-success btn-sm">@lang('view_pages.active')</button>
                                                    </td>
                                                    @else
                                                    <td><button
                                                            class="btn btn-danger btn-sm">@lang('view_pages.inactive')</button>
                                                    </td>
                                                    @endif
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start">
                                                            <a class="dropdown-item"
                                                                href="{{url('zone/types/zone_package_price/edit',$result->id)}}"><i
                                                                    class="fa fa-pencil"></i>@lang('view_pages.edit')</a>


                                                            @if ($result->active)
                                                            <a class="dropdown-item"
                                                                href="{{url('zone/types/zone_package_price/toggleStatus',$result->id)}}"><i
                                                                    class="fa fa-dot-circle-o"></i>@lang('view_pages.inactive')</a>
                                                            @else
                                                            <a class="dropdown-item"
                                                                href="{{url('zone/types/zone_package_price/toggleStatus',$result->id)}}"><i
                                                                    class="fa fa-dot-circle-o"></i>@lang('view_pages.active')</a>
                                                            @endif

                                                            {{-- @if ($result->active == 1 &&
                                                            $result->zone->default_vehicle_type != $result->type_id)
                                                            <a class="dropdown-item"
                                                                href="{{url('zone/set/default',$result->id)}}"><i
                                                                    class="fa fa-dot-circle-o"></i>@lang('view_pages.set_as_default')</a>
                                                            @endif --}}

                                                            <a class="dropdown-item sweet-delete"
                                                                href="{{url('zone/types/zone_package_price/delete',$result->id)}}"><i
                                                                    class="fa fa-trash-o"></i>@lang('view_pages.delete')</a>
                                                        </div>
