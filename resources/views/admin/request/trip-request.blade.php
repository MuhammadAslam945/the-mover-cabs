                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <p class="mb-1 f-12">
                                        ...
                                        @lang('view_pages.payment_type') : <b>{{ $item->payment_opt == 1 ? 'Cash' :
                                            'Card'
                                            }}</b>
                                    </p>
                                    <p class="mb-1 f-12">
                                ...
                                <div class="col-5 my-3">
                                    <a href="{{ $item->driverDetail->profile_picture }}" data-fancybox>
                                        <img class="img-fluid" src="{{ $item->driverDetail->profile_picture }}" alt="">
                                    </a>
                                </div>
                                <div class="col-7 my-3">
                                    ...
                                    <p class="mb-1 f-12">
                                        @lang('view_pages.ratings') : <b>{{ $item->driverDetail->driverDetail->rating }}
                                            <i class="fas fa-star" style="color: yellow;"></i></b>
                                    </p>
                                </div>
                                @endif
                                ...
                                <div class="col-5 my-3">
                                    <a href="{{ $item->zoneType->vehicleType->icon }}" data-fancybox>
                                        <img class="img-fluid" src="{{ $item->zoneType->vehicleType->icon }}" alt="">
                                    </a>
                                </div>
                                <div class="col-7 my-3">
                                    <p class="mb-1 f-12">
                        ...
                        <div class="col card detail-overflow">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <p class="mb-1 f-12">
                                        @lang('view_pages.name') : <b>{{ $item->adHocuserDetail->name ??
                                            $item->userDetail->name}}</b>
                                    </p>
                                    <p class="mb-1 f-12">
                                        @lang('view_pages.phone') : <b>{{ $item->adHocuserDetail->mobile??
                                            $item->userDetail->mobile }}</b>
                                    </p>
                                </div>
