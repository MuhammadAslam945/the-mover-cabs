                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $item->requestRating()->where('user_rating',1)->pluck('rating')->first() }}
                                    </td>
                                    @else
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $item->requestRating()->where('driver_rating',1)->pluck('rating')->first() }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $key == 'total_amount' ? 'highlight' : '' }}">
                                    ...
                                    <td>
                                        ...
                                        {{ $item->currency .' '. $item->requestBill->price_per_distance.' /
                                        '.$item->request_unit }}
...
<script type="text/javascript"
    src="https://maps.google.com/maps/api/js?key={{get_settings('google_map_key')}}&sensor=false&libraries=places">
</script>
