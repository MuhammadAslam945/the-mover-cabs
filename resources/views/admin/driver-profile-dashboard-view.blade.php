...
<div class="page-content-wrapper">
                            ...
                            <div class="profile-user-info">
                                <h3>
                                    <span class="text-gray">{{$item->name}} @if ($item->available == '1')
                                        <span
                                            class="badge badge-success font-size-10">{{trans('view_pages.online')}}</span>
                                        @else
                                        <span
                                            class="badge badge-danger font-size-10">{{trans('view_pages.offline')}}</span>
                                        @endif</span>
                                </h3>
                                <p>
    ...
    <div class="row g-3">
        ...
        <div class="col-sm-6 col-md-3">
            <div class="card overflow-hidden" style="min-width: 12rem">
                <div class="bg-holder bg-card" style="background-image:url({{ asset('assets/images/corner-1.png') }});">
                </div>
                <!--/.bg-holder-->
                <div class="card-body position-relative">
                                ...
                                <table id="tickets" class="table mt-0 table-hover no-wrap table-striped table-bordered"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="label label-danger">@lang('view_pages.cancelled')</span>
                                            </td>
                                            @elseif($trip->is_completed == 1)
                                            <td><span class="label label-success">@lang('view_pages.completed')</span>
                                            </td>
                                            @elseif($trip->is_trip_start == 0 && $trip->is_cancelled == 0)
                                            <td><span class="label label-warning">@lang('view_pages.not_started')</span>
                                            </td>
                                            @else
                                            <td>-</td>
                                            @endif
                                            <td>
                                                <a
                                                    href="{{url('requests/trip_view',$trip->id) }}">@lang('view_pages.view')</a>
                                            </td>
                                        </tr>
                                        @endforeach
