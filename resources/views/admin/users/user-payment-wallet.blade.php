            ...
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('users/payment-history',$item->id)}}"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="amount">@lang('view_pages.amount') <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="amount" name="amount"
                                            value="{{old('amount')}}" required=""
                                            placeholder="@lang('view_pages.enter_amount')">
