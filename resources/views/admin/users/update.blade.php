                        ...
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                ...
                                <form method="post" class="form-horizontal"
                                    action="{{ url('users/update', $results->id) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="gender" id="gender" class="form-control" required>
                                                    ...
                                                    <option value="{{ $results->gender }}" {{ old('gender', $results->
                                                        gender) ==
                                                        $results->gender ? 'selected' : '' }}>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country" class="form-control" required>
                                                ...
                                                <option value="{{ $country->id }}" {{ old('country', $results->country)
                                                    ==
                                                    $country->id ? 'selected' : '' }}>
                                                    {{ $country->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <img class="user-image" id="blah"
                                                src="{{asset( $results->profile_picture) }}" alt=" "><br>
