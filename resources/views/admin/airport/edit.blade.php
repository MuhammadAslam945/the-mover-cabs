                        ...
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                <form method="post" class="form-horizontal"
                                    action="{{url('airport/update',request()->id)}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="zone_admin" class="">@lang('view_pages.select_area')
                                                    <sup>*</sup></label>
                                                <select name="admin_id" id="zone_admin" class="form-control" required>
                                                    ...
                                                    <option value="{{$service->id}}" {{ $service->id ==
                                                        $zone->service_location_id ? 'selected' : ''
                                                        }}>{{$service->name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="zone_name" type="text" name="zone_name"
                                                    ...
                                                    placeholder="@lang('view_pages.enter_name')" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="airport_surge_fee" type="text"
                                                    name="airport_surge_fee"
                                                    value="{{old('airport_surge_fee',$zone->airport_surge_fee)}}"
                                                    placeholder="@lang('view_pages.enter_airport_surge_fee')" required>
                                                <span class="text-danger">{{ $errors->first('airport_surge_fee')
                                                    }}</span>
                                            </div>
                                        </div>
