                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start">
                                    <a class="dropdown-item" href="{{url('airport/mapview',$result->id)}}"><i
                                            class="fa fa-eye"></i>@lang('view_pages.map_view')</a>
                                    <a class="dropdown-item" href="{{url('airport/edit',$result->id)}}"><i
                                    ...
                                    <a class="dropdown-item sweet-delete" href="#"
                                        data-url="{{url('airport/delete',$result->id)}}"><i
