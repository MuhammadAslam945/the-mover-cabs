                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td class="manage-driver text-center">
                                    <a href="{{url('fleets/document/view', $result->id) }}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{url('fleets/assign_driver',$result->id) }}">{{
                                                trans('view_pages.assign_driver')}}</a>
                                            @else
                                            @if (auth()->user()->can('edit-fleet'))
                                            <a class="dropdown-item" href="{{url('fleets/edit',$result->id) }}">{{
                                            ...
                                            @if($result->approve)
                                            {{-- sweet-decline --}}
                                            <a class="decline dropdown-item" data-reason="{{ $result->reason }}"
                                                data-id="{{ $result->id }}"
                                                href="{{url('fleets/toggle_approve',$result->id)}}">@lang('view_pages.decline')</a>
                                            @else
                                            <a class="sweet-approve dropdown-item"
                                                href="{{url('fleets/toggle_approve',$result->id)}}">@lang('view_pages.approve')</a>
                                            @endif
                                            @endif

                                            @if (auth()->user()->can('delete-fleet'))
                                            <a class="sweet-delete dropdown-item"
                                                href="{{url('fleets/delete',$result->id) }}">{{
                                                trans('view_pages.delete')}}</a>
                                            @endif
                                            @endif
                                        </div>
                                    </div>
