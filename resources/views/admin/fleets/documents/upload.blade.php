                        ...
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                <form method="post" class="form-horizontal"
                                    action="{{url('fleets/upload/document',[$fleet->id,$needed_document->id])}}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="identify_number"
                                                    ...
                                                    value="{{ old('identify_number',$fleetDoc ? $fleetDoc->identify_number : '') }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control datepicker" type="text" id="expiry_date"
                                                    name="expiry_date"
                                                    value="{{old('expiry_date',$fleetDoc ? $fleetDoc->expiry_date : '')}}"
