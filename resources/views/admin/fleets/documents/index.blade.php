                                ...
                                <form action="#" method="post">
                                    ...
                                    <table class="table table-hover"
                                        ...
                                        <tbody>
                                            ...
                                            @endforeach
                                            <tr>
                                                <input type="hidden" name="fleet_id" class="fleet_id"
                                                    value="{{ $fleet->id }}">
                                                ...
                                                <td>
                                                    @if($count == 0)
                                                    <span
                                                        class="badge badge-danger">@lang('view_pages.not_uploaded')</span>
                                                    @else
                                                    @if ($doc_status == 1)
                                                    <span class="badge badge-success">{{
                                                        driver_document_name($doc_status)
                                                        }}</span>
                                                    @elseif ($doc_status == 5)
                                                ...
                                                <td>
                                                    @if($count > 0)
                                                    <a href="#" class="open-image fas fa fa-eye"
                                                        data-src="{{ $image }}"></a>
                                                    @else
                                                    -
                                                    @endif
                                                ...
                                                <td>
                                                    @if($count == 0)
                                                    <a href="{{url('fleets/upload/document',[$fleet->id,$item->id]) }}"
                                                        class="fas fa fa-upload"></a>
                                                    @else
                                                    <a href="{{url('fleets/upload/document',[$fleet->id,$item->id]) }}"
                                                        class="fas fa fa-edit"></a>
                                                    {{-- <a href="{{ $image }}" target="_blank"
                                                        class="fas fa fa-eye"></a>
                                                    --}}
                                                    @endif
                                                </td>
                                                <td>
                                    ...
                                    <div class="form-group">
                                        <div class="col-12 mt-3">
                                            <button class="btn btn-primary btn-sm pull-right" id="approveDocument"
                                                type="button">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" data-bs-dismiss="modal" class="btn btn-danger btn-sm float-right">
