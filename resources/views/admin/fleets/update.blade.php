                    ...
                    <div class="row">
                        <div class="col-sm-4 float-left mb-md-3">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control" required>
                                    ...
                                    <option value="{{ $type->id }}" {{ old('type',$item->vehicle_type) == $type->id ?
                        ...
                        <div class="col-sm-4 float-left mb-md-3">
                            <div class="form-group">
                                ...
                                <select name="brand" id="brand" class="form-control select2" required>
                                    ...
                                    <option value="{{ $make->id }}" {{ old('brand',$item->brand) == $make->id ?
                        ...
                        <div class="col-sm-6 float-left mb-md-3">
                            <div class="form-group">
                                ...
                                <input id="license_number" name="license_number"
                                    ...
                                    class="form-control" value="{{ old('license_number',$item->license_number) }}"
                                    required>
                        ...
                        <div class="col-12 btn-group mt-3">
                            <button type="submit" class="btn btn-primary mr-1 waves-effect waves-light">{{
                                trans('view_pages.update')}}</button>
                        </div>
                    </div>
                </form>
            </div>
