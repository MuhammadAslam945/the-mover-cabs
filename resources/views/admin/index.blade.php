...
<div class="page-content-wrapper">
                ...
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <div class="card-body position-relative">
                        <h6>@lang('view_pages.drivers_approved')<span
                                class="badge badge-soft-success rounded-pill ml-2">{{number_format($driver_approval_percent,2)}}%</span>
                        </h6>
                ...
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <div class="card-body position-relative">
                        <h6>@lang('view_pages.drivers_waiting_for_approval')<span
                                class="badge badge-soft-success rounded-pill ml-2">{{number_format($driver_approval_waiting_percent,2)}}%</span>
                        </h6>
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-warning"
                            data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">
    ...
    <script src="http://localhost/tagyourtaxi/future/public/assets/vendor_components/jquery.peity/jquery.peity.js">
    </script>
