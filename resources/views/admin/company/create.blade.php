                    ...
                    <div class="col-sm-12">
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                ...
                                <form method="post" class="form-horizontal" action="{{url('company/store')}}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="owner_name"
                                                    ...
                                                    placeholder="@lang('view_pages.enter_owner_name')">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" id="vat_number"
                                                    ...
                                                    placeholder="@lang('view_pages.enter_vat_number')">
