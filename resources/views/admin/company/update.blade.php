                        ...
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                ...
                                <form method="post" class="form-horizontal"
                                    action="{{url('company/update',$result->id)}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="service_location_id" id="service_location_id"
                                                ...
                                                <option value="{{$location->id}}" {{ old('location',$result->
                                                    service_location_id) == $location->id ? 'selected' : ''
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="owner_name"
                                                    name="owner_name" value="{{old('owner_name',$result->owner_name)}}"
                                                    required="" placeholder="@lang('view_pages.enter_owner_name')">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="landline" name="landline"
                                                    value="{{old('landline',$result->landline)}}" required=""
                                                    placeholder="@lang('view_pages.enter_landline')">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" id="vat_number"
                                                    name="vat_number" value="{{old('vat_number',$result->vat_number)}}"
                                                    required="" placeholder="@lang('view_pages.enter_vat_number')">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="country" id="country" class="form-control" required>
                                                    ...
                                                    <option value="{{$country->id}}" {{ old('country',$result->country)
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="state" name="state"
                                                    value="{{old('state',$result->state)}}" required=""
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="city" name="city"
                                                    value="{{old('city',$result->city)}}" required=""
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" id="city" name="postal_code"
                                                    value="{{old('postal_code',$result->postal_code)}}" required=""
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="address" name="address"
                                                    value="{{old('address',$result->address)}}" required=""
                                                ...
                                                <div class="imageupload panel panel-default">
                                                    ...
                                                    <div class="file-tab panel-body">
                                                        ...
                                                        <button type="button" class="btn btn-danger"
                                                            style="margin-bottom: 0.5rem; display: none;">@lang('view_pages.remove')</button>
                                                    </div>
