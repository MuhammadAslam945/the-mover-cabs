                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" class="form-horizontal" action="{{ url('promo/update',$item->id) }}">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="service_location_id" id="service_location_id" class="form-control"
                                            ...
                                            <option value="{{ $city->id }}" {{ old('service_location_id',$item->
                                                service_location_id) == $city->id ? 'selected' : '' }} >{{ $city->name
                                                }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="maximum_discount_amount">@lang('view_pages.maximum_discount_amount')
