                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="role" id="role" class="form-control"
                                                    ...
                                                    <option value="" selected disabled>@lang('view_pages.select_role')
                                                    </option>
                                                    @foreach ($roles as $key => $role)
                                                    <option value="{{ $role->slug }}" {{ old('role')==$role->slug ?
                                                        'selected' : '' }}>{{ $role->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="country" id="country" class="form-control" required>
                                                    <option value="" selected disabled>
                                                        @lang('view_pages.select_country')
                                                    </option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" id="city" name="postal_code"
                                                    min="1" value="{{ old('postal_code') }}" required=""
