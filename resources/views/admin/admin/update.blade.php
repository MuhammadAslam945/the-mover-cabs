                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('admins/update',$item->id)}}"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="role" id="role" class="form-control"
                                            ...
                                            <option value="{{$role->slug}}" {{ old('role',$item->user->roles[0]->slug)
                                                == $role->slug ? 'selected' : '' }}>{{$role->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6" id="serviceLocation" style="display:none">
                                    <div class="form-group">
                                        ...
                                        <select name="service_location_id" id="service_location_id"
                                            ...
                                            <option value="{{$service->id}}" {{ old('service_location_id',$item->
                                                service_location_id) == $service->id ? 'selected' : ''
                                                }}>{{$service->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="first_name">@lang('view_pages.first_name') <span
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="last_name">@lang('view_pages.last_name') <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="country" id="country" class="form-control" required>
                                            ...
                                            <option value="{{$country->id}}" {{ old('country',$item->country) ==
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="state">@lang('view_pages.state') <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="postal_code">@lang('view_pages.postal_code') <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" type="number" min="1" id="city" name="postal_code"
                                            value="{{old('postal_code',$item->pincode)}}" required=""
