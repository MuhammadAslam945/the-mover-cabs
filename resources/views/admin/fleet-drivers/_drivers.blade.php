...
@endif -->
        ...
        @endif -->
                                    ...
                                    <a class="dropdown-item decline" data-reason="{{ $result->reason }}"
                                        data-id="{{ $result->id }}"
                                        href="{{url('fleet-drivers/toggle_approve',['driver'=>$result->id,'approval_status'=>0])}}">
                                        <i class="fa fa-dot-circle-o"></i>@lang('view_pages.disapproved')</a>

                                    <a class="dropdown-item"
                                        href="{{url('fleet-drivers/toggle_approve',['driver'=>$result->id,'approval_status'=>1])}}">
        ...
        @endif -->
                                    ...
                                    <a class="dropdown-item sweet-delete" href="#"
                                        data-url="{{url('fleet-drivers/delete',$result->id)}}">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{url('fleet-drivers/payment-history',$result->id)}}">
