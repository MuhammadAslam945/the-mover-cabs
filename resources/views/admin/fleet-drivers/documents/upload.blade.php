                        ...
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                <form method="post" class="form-horizontal"
                                    action="{{url('drivers/upload/document',[$driver->id,$needed_document->id])}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="identify_number"
                                                    ...
                                                    value="{{ old('identify_number',$driverDoc ? $driverDoc->identify_number : '') }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control datepicker" type="text" id="expiry_date"
                                                    name="expiry_date"
                                                    value="{{old('expiry_date',$driverDoc ? $driverDoc->expiry_date : '')}}"
                                                    required="" placeholder="@lang('view_pages.enter_expiry_date')"
                                                    autocomplete="off">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="document" onchange="readURL(this)" name="document"
                                                style="display:none">
