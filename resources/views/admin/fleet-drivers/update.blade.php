                ...
                <div class="box">
                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" class="form-horizontal"
                            action="{{ url('fleet-drivers/update', $item->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="form-control" required>
                                            ...
                                            <option value="{{ $type->id }}" {{ old('type', $item->vehicle_type) ==
                                                $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="car_make" id="car_make" class="form-control select2" required>
                                            ...
                                            <option value="{{ $make->id }}" {{ old('car_make', $item->car_make) ==
                                                $make->id ? 'selected' : '' }}>
                                                {{ $make->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="car_model" id="car_model" class="form-control select2" required>
                                            ...
                                            <option value="{{ $model->id }}" {{ old('car_model', $item->car_model) ==
                                                $model->id ? 'selected' : '' }}>
                                                {{ $model->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="owner_id" id="owner_id" class="form-control" required>
                                            ...
                                            <option value="{{ $owner->id }}" {{ old('owner_id', $owner->id) ==
                                                $owner->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="col-6">
                                        ...
                                        <img class="user-image" id="blah"
                                            src="{{asset( $item->user->profile_picture) }}" alt=" "><br>
