            ...
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        ...
                        <span class="text-danger">@lang('view_pages.note') :
                            @lang('view_pages.please_update_to_save_changes')</span>
                    </div>

                    <div class="col-sm-12">

                        <form method="post" class="form-horizontal" action="{{url('zone/surge/update',$zone->id)}}"
                            ...
                            <table class="table surgeTable">
                                <thead>
                                    ...
                                    <th> @lang('view_pages.surge_price_in_percentage') <span
                                ...
                                <tbody class="append_row">
                                    ...
                                    <tr>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="start_time[]"
                                                            value="{{ old('start_time.'.$k,$surgeValue->from) }}"
                                                            class="start_time form-control timepicker">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="end_time[]"
                                                            value="{{ old('end_time.'.$k,$surgeValue->to) }}"
                                                            class="end_time form-control timepicker">
                                                    </div>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input class="form-control" type="number" min="1" max="100" id="name"
                                                    name="price[]" value="{{old('price.'.$k,$surgeValue->value)}}"
                                                    required="" placeholder="@lang('view_pages.enter_price')">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input class="form-control" type="number" min="1" max="100" id="name"
                                                    name="price[]" value="{{old('price.'.$k)}}" required=""
                                                    placeholder="@lang('view_pages.enter_price')">
                                                <span class="text-danger">{{ $errors->first('price.0') }}</span>
                                            </div>
                                        </td>
                                        <td>
