        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <div class="col-sm-12">
                        <form method="post" class="form-horizontal" action="{{url('zone/assign/types',$zone->id)}}"
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="base_distance">@lang('view_pages.select_base_distance')
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{old('ride_now_waiting_charge')}}" required=""
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{old('ride_later_price_per_distance')}}" required=""
                                                            placeholder="@lang('view_pages.enter') @lang('view_pages.distance_price')">
                                                        <span class="text-danger">{{
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="number"
                                                            ...
                                                            value="{{old('ride_later_base_distance')}}" required=""
                                                            placeholder="@lang('view_pages.base_distance')">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{old('ride_later_price_per_time')}}" required=""
                                                            placeholder="@lang('view_pages.enter') @lang('view_pages.price_per_time')">
                                                        <span class="text-danger">{{
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{old('ride_later_cancellation_fee')}}" required=""
                                                            placeholder="@lang('view_pages.enter') @lang('view_pages.cancellation_fee')">
                                                        <span class="text-danger">{{
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            ...
                                                            value="{{old('ride_later_waiting_charge')}}" required=""
                                                            placeholder="@lang('view_pages.enter') @lang('view_pages.waiting_charge')">
                                                        <span class="text-danger">{{
