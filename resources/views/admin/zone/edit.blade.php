                        ...
                        <div class="box">
                            ...
                            <div class="col-sm-12">
                                <form method="post" class="form-horizontal"
                                    action="{{url('zone/update',request()->id)}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="zone_admin"
                                                    class="">@lang('view_pages.select_unit')<sup>*</sup></label>
                                                <select name="unit" id="unit" class="form-control" required>
                                                    <option value="" selected disabled>@lang('view_pages.select_unit')
                                                    </option>
                                                    <option value="1" {{ 1==$zone->unit ? 'selected' : '' }}>Kilo-Meter
                                                    </option>
                                                    <option value="2" {{ 2==$zone->unit ? 'selected' : '' }}>Miles
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
