        ...
        <tr>
            ...
            <td>
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{url('fleet_needed_doc',$result->id)}}"><i
                            class="fa fa-pencil"></i>@lang('view_pages.edit')</a>

                    @if($result->active)
                    <a class="dropdown-item" href="{{url('fleet_needed_doc/toggle_status',$result->id)}}"><i
                    ...
                    {{-- <a class="dropdown-item sweet-delete" href="{{url('needed_doc/delete',$result->id)}}"><i
