                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="make_id" id="make_id" class="form-control select2"
                                            data-placeholder="@lang('view_pages.select_car_make')" required>
                                            <option value="" selected disabled>@lang('view_pages.select_car_make')
                                            </option>
                                            @foreach ($makes as $key => $make)
                                            <option value="{{ $make->id }}" {{ old('make_id',$item->make_id) ==
                                                $make->id ? 'selected' : '' }} >{{ $make->name }}</option>
                                            @endforeach
                                        </select>
