        ...
        <tr>
            ...
            <td>
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{url('carmodel',$result->id)}}"><i
                            class="fa fa-pencil"></i>@lang('view_pages.edit')</a>

                    @if($result->active)
                    <a class="dropdown-item" href="{{url('carmodel/toggle_status',$result->id)}}"><i
                    ...
                    {{-- <a class="dropdown-item sweet-delete" href="{{url('carmodel/delete',$result->id)}}"><i
