...
//print_r(json_encode($array));die();s
?>
<div class="page-content-wrapper">
    ...
    echo " active"; }?>"> {{trans('view_pages.'.$setting_key)}}
                                    </a>
                                </li>
                                <?php $tab++;} ?>
    ...
    echo " active"; }?>" id="{{$setting_key}}">
                      ...
                      /*select box*/    if ($setting_name['field']=="select") { ?>
                                                        <select name="<?=$setting_name['name'];?>" class="form-control"
                                                            id="title">
                                                            <?php
                                                ...
                                                if ($setting_name['value'] == $option_value) {
                                                    ...
                                                    $sel="";
                                                            ...
                                                            <option style="text-align: left;"
                                                                value="<?=$option_value; ?>" <?=$sel?> >
                                                                <?php echo trans('view_pages.'.$option_name); ?>
                                                            </option>
                                                            <?php
                                            } ?>
                                                        </select>
                      ...
                      /*text box*/      elseif ($setting_name['field']=="text") { ?>
                                                        <input name="<?=$setting_name['name'];?>" type="text"
                                                            value='<?=$setting_name[' value']?>' class="form-control"
                                                        id="title">
                                                        <?php }
                                          elseif ($setting_name['field']=="password") { ?>
                                                        <input name="<?=$setting_name['name'];?>" type="password"
                                                            value='<?=$setting_name[' value']?>' class="form-control"
                                                        id="title">
                                                        <?php }
                                                        ...
                                                        {{-- <div class="imageupload panel panel-default">
                                                            <div class="file-tab panel-body"> --}}
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-6">
                                                                        <img id="blah"
                                                                            src="{{  $setting_name['name'] == 'logo' ? app_logo() : fav_icon() }}"
                                                                            alt=""
                                                                            style="max-width: 250px; max-height: 250px"><br>
                                                                        <input type="file"
                                                                            id="{{ $setting_name['name'] }}"
                                                                            onchange="readURL(this)"
                                                                            name="{{ $setting_name['name'] }}"
                                                                            style="display:none"><br>
                                                                        <button class="btn btn-primary btn-sm"
                                                                            type="button"
                                                                            onclick="$({{ $setting_name['name'] }}).click()"
                                                                            id="upload">@lang('view_pages.browse')</button>
                                                                        <button class="btn btn-danger btn-sm"
                                                                            type="button" id="remove_img"
                                                                            style="display: none;">@lang('view_pages.remove')</button><br>
                                                                        <span class="text-danger">{{
                                                                            $errors->first($setting_name['name'])
                                                                            }}</span>
                                                                    </div>
                                                                </div>
                      ...
                      /*text area  */   elseif ($setting_name['field']=="textarea") { ?>
                                                        <textarea name="<?=$setting_name['name'];?>"
                                                            class="form-control" id="title" maxlength="225"
                                                            rows="3"><?=$setting_name['value']?></textarea>
                                                        <?php } ?>
                                 ...
                                 $group_count++; } ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group text-right m-b-0">
                                                    <button class="btn btn-custom waves-effect waves-light"
                                                        type="submit">
