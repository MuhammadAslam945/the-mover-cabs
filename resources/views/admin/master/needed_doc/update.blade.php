                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" class="form-horizontal" action="{{ url('needed_doc/update',$item->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="">@lang('view_pages.document_for') <span
                                                class="text-danger">*</span></label>
                                        <select name="document_for" id="document_for" class="form-control" required>
                                            <option value="" selected disabled>@lang('view_pages.select')</option>
                                            <option value="1" {{ old('is_individual',$item->is_individual) == '1' ?
                                                'selected' : '' }}>@lang('view_pages.individual')</option>
                                            <option value="0" {{ old('is_individual',$item->is_individual) == '0' ?
                                                'selected' : '' }}>@lang('view_pages.fleet_drivers')</option>
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="">@lang('view_pages.has_expiry_date') <span
                                                class="text-danger">*</span></label>
                                        <select name="has_expiry_date" id="has_expiry_date" class="form-control"
                                            required>
                                            <option value="" selected disabled>@lang('view_pages.select')</option>
                                            <option value="1" {{ old('has_expiry_date',$item->has_expiry_date) == '1' ?
                                                'selected' : '' }}>@lang('view_pages.yes')</option>
                                            <option value="0" {{ old('has_expiry_date',$item->has_expiry_date) == '0' ?
                                                'selected' : '' }}>@lang('view_pages.no')</option>
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="">@lang('view_pages.has_identify_number') <span
                                                class="text-danger">*</span></label>
                                        <select name="has_identify_number" id="has_identify_number" class="form-control"
                                            required>
                                            <option value="" selected disabled>@lang('view_pages.select')</option>
                                            <option value="1" {{ old('has_identify_number',$item->has_identify_number)
                                                == '1' ? 'selected' : '' }}>@lang('view_pages.yes')</option>
                                            <option value="0" {{ old('has_identify_number',$item->has_identify_number)
                                                == '0' ? 'selected' : '' }}>@lang('view_pages.no')</option>
                                        </select>
                                ...
                                <div class="col-sm-6 d-none" id="identify_number_div">
                                    <div class="form-group">
                                        <label
                                            for="identify_number_locale_key">@lang('view_pages.identify_number_locale_key')
                                            <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="identify_number_locale_key"
                                            name="identify_number_locale_key"
                                        ...
                                        <span class="text-danger">{{ $errors->first('identify_number_locale_key')
                                            }}</span>
                                    </div>
                                </div>
                            </div>
