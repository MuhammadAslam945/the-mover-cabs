        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box">
                    ...
                    <div class="mb-3">
                        <form method="post" class="form-horizontal" action="{{url('builds/store')}}"
                                    ...
                                    <div class="form-group">
                                        <div class="col-12">
                                            ...
                                            <select name="team" id="team" class="form-control">
                                                <option value="" selected disabled>@lang('view_pages.select_team')
                                                </option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-12">
                                            ...
                                            <select name="project_id" id="project_id" class="form-control">
                                                <option value="" selected disabled>@lang('view_pages.select_project')
                                                </option>
                                                @foreach($projects as $key=>$project)
                                                <option value="{{$project->id}}" {{ old('project_id')==$project->id ?
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="col-12">
                                            <label for="admin_id">@lang('view_pages.select_flavour')<span
                                                    class="text-danger">*</span></label>
                                            <select name="flavour_id" id="flavour_id" class="form-control">
                                                <option value="" selected disabled>@lang('view_pages.select_flavour')
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="environment" id="environment" class="form-control">
                                                <option value="" selected disabled>
                                                    @lang('view_pages.select_environment')</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-12">
                                            ...
                                            <input class="form-control" type="text" id="version" name="version"
                                                ...
                                                placeholder="@lang('view_pages.enter_version')">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="col-12">
                                            ...
                                            <input class="form-control" type="file" id="build" name="build" value=""
                                                required="" placeholder="@lang('view_pages.upload_build')">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" type="text" id="additional_comments"
