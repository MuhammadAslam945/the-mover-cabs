...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('builds/projects') }}"><i class="fa fa-dashboard"></i>
                {{$project_name}}</a></li>
        <li class="breadcrumb-item"><a href="{{ url('builds/flavours',request()->project_id) }}"><i
                    class="fa fa-dashboard"></i> {{$flavour_name}}</a></li>

        <li class="breadcrumb-item"><a
                href="{{ url('builds/environments',['project_id'=>request()->project_id,'flavour_id'=>request()->flavour_id]) }}"><i
                    class="fa fa-dashboard"></i> {{$environment}}</a></li>
...
<section class="col-12" style="padding-top:25px;">
    <div class="col-md-11 mx-auto apk-download-main-div mb-1 ">
        <ul class="top-search">
            <li>
                <div class="form-group mb-0">
                    <input type="text" name="search" style="width:250px;" class="form-control"
            ...
            <li>
                <a
                    href="{{url('builds?team=android',['project_id'=>request()->project_id,'flavour_id'=>request()->flavour_id,'environment'=>request()->environment])}}">
                    <button class="btn btn-danger btn-outline btn-sm {{$android_active}}" type="button">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.12 512.12"
                            style="enable-background:new 0 0 512.12 512.12;" xml:space="preserve">
                            <g>
		...
		c5.891,0,10.667-4.776,10.667-10.667C384.256,100.804,365.284,65.283,333.607,44.323z" />
            ...
            <li>
                <a
                    href="{{url('builds?team=ios',['project_id'=>request()->project_id,'flavour_id'=>request()->flavour_id,'environment'=>request()->environment])}}">
                    <button class="btn btn-warning btn-outline btn-sm {{$ios_active}}" type="button">
                        <svg id="Layer_1" enable-background="new 0 0 256 256" viewBox="0 0 256 256"
                            ...
                            <path
                                d="m227 252h-198c-13.807 0-25-11.193-25-25v-198c0-13.807 11.193-25 25-25h198c13.807 0 25 11.193 25 25v198c0 13.807-11.193 25-25 25z"
                                fill="#526faa" />
                            <path
                                d="m227 4h-10c13.807 0 25 11.193 25 25v198c0 13.807-11.193 25-25 25h10c13.807 0 25-11.193 25-25v-198c0-13.807-11.193-25-25-25z"
                                fill="#34518c" />
                            <path
                                d="m14 227v-198c0-13.807 11.193-25 25-25h-10c-13.807 0-25 11.193-25 25v198c0 13.807 11.193 25 25 25h10c-13.807 0-25-11.193-25-25z"
                                fill="#708dc8" />
                            <path
                                d="m227 254h-198c-14.888 0-27-12.112-27-27v-198c0-14.888 12.112-27 27-27h198c14.888 0 27 12.112 27 27v198c0 14.888-12.112 27-27 27zm-198-248c-12.683 0-23 10.318-23 23v198c0 12.682 10.317 23 23 23h198c12.683 0 23-10.318 23-23v-198c0-12.682-10.317-23-23-23z"
                                fill="#690589" />
                            <path d="m14 74c-1.104 0-2-.896-2-2v-12c0-1.104.896-2 2-2s2 .896 2 2v12c0 1.104-.896 2-2 2z"
                                fill="#690589" />
                            <path
                                d="m135.672 41.77c-9.054 9.054-12.012 21.87-8.937 33.412 11.543 3.075 24.359.118 33.413-8.936s12.012-21.87 8.936-33.413c-11.542-3.075-24.358-.118-33.412 8.937z"
                                fill="#f4efed" />
                            <path
                                d="m202.842 166.911c-20.94 0-37.915-16.975-37.915-37.915 0-16.484 10.539-30.472 25.232-35.694-14.376-12.976-33.047-10.873-45.779-7.048-9.346 2.808-19.253 2.808-28.599 0-17.443-5.241-46.044-7.285-59.457 28.313-13.915 36.926 5.991 74.447 23.842 97.541 9.81 12.691 27.645 15.911 41.46 7.761l4.447-2.623c2.473-1.459 5.543-1.459 8.016 0l4.447 2.623c13.815 8.15 31.65 4.93 41.46-7.761 9.221-11.93 18.979-27.714 24.352-45.273-.504.02-.998.076-1.506.076z"
                                fill="#f4efed" />
                            <g fill="#690589">
                                <path
                                    d="m135.644 78.347c-3.146 0-6.312-.403-9.423-1.232-.692-.185-1.233-.725-1.418-1.418-3.359-12.608.264-26.151 9.455-35.341 9.192-9.191 22.737-12.812 35.341-9.456.692.185 1.233.725 1.418 1.418 3.359 12.608-.264 26.151-9.454 35.342-6.924 6.923-16.318 10.687-25.919 10.687zm-7.257-4.816c10.903 2.488 22.437-.789 30.348-8.699 7.909-7.91 11.188-19.442 8.698-30.347-10.906-2.49-22.437.791-30.347 8.699-7.91 7.91-11.189 19.441-8.699 30.347z" />
                                <path
    ...
    @if(count($results)<1) <p id="no_data" class="lead no-data text-center">
        ...
        <div class="col-md-11 mx-auto apk-download-main-div">
            <div class="apk-download col-12">
                <div class="col-6 col-md-6 float-left apk-download-left">
                    <p><b class="apk-name"> {{$result->build_number}}</b> <span><b class="version-apk">Version:</b>
                            v{{$result->version}}</span> <span><b class="version-apk">Platform:</b>
                            {{$result->team}}</span></p>
                    <p>{{$result->short_additional_comments}}</p>
                </div>
                <div class="col-6 col-md-6 float-left apk-download-right">
                    <p><span><b class="version-apk mobile-div">Date:</b> {{$result->created_at}}</span> <span><b
                                class="version-apk mobile-div">File Size:</b> {{$result->file_size}}</span></p>
                    <a href="{{ $result->download_link}}">Download</a>
                    <a data-toggle="modal" style="cursor:pointer;" data-target="#myModal{{$result->id}}"
                        class="mr-0"><img src="../../../assets/img/eye.svg" width="20px" alt=""></a>
                    @if(access()->hasRole('super-admin'))
                    <a href="{{ url('builds/app/delete',$result->id) }}" class="mr-0 sweet-delete"><img
                            src="../../assets/img/delete.svg" width="20px" alt=""></a>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body apk-download">
                        ...
                        <span class="model-apk"> <a style="color:#3d94de"
                                href="{{ $result->download_link}}">Download</a></span>
