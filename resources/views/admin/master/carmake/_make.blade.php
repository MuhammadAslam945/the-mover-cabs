            ...
            <td>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{url('carmake',$result->id)}}"><i
                                class="fa fa-pencil"></i>@lang('view_pages.edit')</a>

                        @if($result->active)
                        <a class="dropdown-item" href="{{url('carmake/toggle_status',$result->id)}}"><i
                        ...
                        {{-- <a class="dropdown-item sweet-delete" href="{{url('carmake/delete',$result->id)}}"><i
