                ...
                <div class="box">
                    ...
                    <div class="mb-3">
                        <form method="post" class="form-horizontal"
                            action="{{url('roles/assign/permissions/update',$role->id)}}">
                            {{csrf_field()}}
                            <div class="form-group m-b-25 mt-10">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="text" id="name" name="name"
                                        ...
                                        placeholder="@lang('view_pages.enter_role')" disabled>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapse_{{$key}}" class="collapse" aria-labelledby="heading_{{$key}}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            @endif
                                            @endforeach
                                            <input class="form-group" id="checkbox_{{$permission->id}}" type="checkbox"
